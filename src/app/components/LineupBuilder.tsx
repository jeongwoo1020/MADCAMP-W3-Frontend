      ...
      <div className="max-w-[1600px] mx-auto relative z-10">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-gradient-to-br from-yellow-400 via-orange-500 to-red-600 rounded-full flex items-center justify-center shadow-2xl border-4 border-white/20">
              <Users className="w-8 h-8 text-white" />
            </div>
            <h2 className="text-5xl font-black bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 bg-clip-text text-transparent drop-shadow-2xl">
              라인업 빌더
            </h2>
          </div>
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              className="h-16 px-8 text-lg bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 font-black shadow-2xl"
            >
              라인업 확정 및 경기 시작
            </Button>
          </div>
          ...
          <div className="col-span-7">
            <Card className="p-6 min-h-[800px] flex flex-col">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                팀을 선택하고 선수를 드래그해서 라인업으로
                구성하세요. (최대 {MAX_CREDITS} 크레딧)
              </p>
          ...
          <div className="col-span-3 space-y-4">
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div
                  className={`text-xl font-bold ${remainingCredits < 0 ? "text-red-600" : "text-black-600"}`}
                >
